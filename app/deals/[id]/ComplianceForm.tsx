...
export default function ComplianceForm({ deal }: { deal: any }) {
  ...
  async function generateField(field: string) {
    ...
    const prompts: Record<string, string> = {
      needsPrimary: `You are a compliance officer for an Australian mortgage brokerage. Write the "Primary reasons for seeking credit / needs and objectives" field for SalesTrekker CRM. Client: ${context.clientName}. Loan: $${context.loanAmount} for ${context.loanType}. Property: ${context.suburb}. Income: $${context.incomeBase} base. Recommended lender: ${context.recommendedLender}. Cover: purpose of loan, loan amount and term, specific features requested, savings position, personal circumstances. Write 4-6 professional sentences. No dot points. Australian mortgage broker tone. Must comply with SFG Best Interests Duty Policy.`,
      needsImmediate: `You are a compliance officer for an Australian mortgage brokerage. Write the "Immediate needs and objectives — within next 2 years" field. Client: ${context.clientName}. Loan type: ${context.loanType}. Cover: what the client wants to achieve in next 2 years and how it may affect the loan. Reference: overseas travel, family, property upgrades, investments where relevant. Write 3-4 professional sentences. No dot points.`,
      needsLongTerm: `You are a compliance officer for an Australian mortgage brokerage. Write the "Longer term needs and objectives — 2 to 10 years" field. Client: ${context.clientName}. Dependants: ${context.dependants}. Cover: debt reduction, retirement planning, education costs, investment goals. Write 3-4 professional sentences. No dot points.`,
