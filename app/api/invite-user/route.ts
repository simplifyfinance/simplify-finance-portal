...
export async function POST(req: NextRequest) {
  ...
  // Try to create auth user — if they already exist, that's fine, we still send the welcome email
  ...
  // Send welcome email via Resend — fires whether new or existing user
